  ...
  return (
    <div className="bg-linear-to-r from-orange-50 via-[#F2F8FF] to-pink-50 px-6 py-2.5 text-center border-b border-gray-100">
      <p className="text-[13px] font-medium text-ink-body">
        🇰🇷 Now onboarding 20 new Korean brands this quarter — <span className="text-brand font-semibold">limited spots for Q3 cohort</span>
      </p>
    </div>
  );
}
      ...
      <nav className="mx-auto flex max-w-[1248px] items-center justify-between px-6 py-4 lg:px-12">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="#features" className="text-[14px] font-medium text-gray-500 hover:text-gray-900 transition-colors">Features</a>
            <a href="#pricing" className="text-[14px] font-medium text-gray-500 hover:text-gray-900 transition-colors">Pricing</a>
            <a href="#testimonials" className="text-[14px] font-medium text-gray-500 hover:text-gray-900 transition-colors">Testimonials</a>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <AuthGuard requireAuth={false}>
            <Link to="/signin" className="text-[14px] font-semibold text-gray-600 transition-colors hover:text-gray-900">
              Log in
            </Link>
            <Link
              to="/signup"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#features" className="text-[14px] text-gray-500 hover:text-gray-900 transition-colors">Features</a></li>
              <li><a href="#pricing" className="text-[14px] text-gray-500 hover:text-gray-900 transition-colors">Pricing</a></li>
              <li><a href="#testimonials" className="text-[14px] text-gray-500 hover:text-gray-900 transition-colors">Testimonials</a></li>
            </ul>
          </div>
        </div>
