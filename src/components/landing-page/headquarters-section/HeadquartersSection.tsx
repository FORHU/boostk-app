        ...
        <div className="max-w-7xl mx-auto w-full px-4">
          ...
          <div className="perspective-2000 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col order-1 space-y-4">
              <ModuleCard title="Marketing & Content Strategy" icon="campaign" />
              <ModuleCard title="Sales & Lead Generation" icon="shopping_cart" />
              <ModuleCard title="Global Client Communication" icon="support_agent" />
              <ModuleCard title="Business Planning Strategy" icon="strategy" />
            </div>
              ...
              <div className="relative w-full max-w-2xl">
                <div className="relative bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden p-10 lg:p-12">
                  <div className="flex flex-col items-center text-center">
                    ...
                    {/* Title */}
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">Partnership Model</h3>
