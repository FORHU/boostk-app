        ...
        <div className="bg-[#3b82f5] rounded-2xl md:rounded-3xl p-8 sm:p-12 md:p-16 border border-blue-600 max-w-4xl mx-auto shadow-xl text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mb-8">
              <button
                type="button"
                className="px-8 py-3.5 bg-white text-[#3b82f5] font-bold text-base rounded-lg hover:bg-blue-700 hover:text-white hover:shadow-lg hover:-translate-y-0.5 active:bg-blue-600 active:translate-y-0 transition-all duration-200"
              >
                Get Started Now
              </button>
            </div>
