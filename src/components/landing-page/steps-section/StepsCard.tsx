...
export const StepsCard: React.FC<StepCardProps> = ({ animationClass, stepNumber, title, description, icon }) => {
  return (
    <div className={`relative group w-full cursor-pointer ${animationClass}`}>
      {/* 3D Depth Effect Layer */}
      <div className="absolute top-2 left-1 right-[-4px] bottom-[-8px] bg-slate-200 rounded-xl transform -skew-x-2 z-0 transition-transform duration-300"></div>
