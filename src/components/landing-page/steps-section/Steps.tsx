        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-50 border border-blue-100 shadow-sm">
              ...
              <span className="text-[11px] font-bold tracking-widest text-blue-600 uppercase">Upward Growth Plan</span>
            </div>
          </div>
          ...
          <p className="text-base text-slate-500 max-w-xl mx-auto leading-relaxed">3 steps to global growth</p>
        </div>
