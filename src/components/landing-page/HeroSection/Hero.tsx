...
export const Hero = () => {
  ...
  return (
    <>
      <Navbar />
      <header className="pt-20 pb-8 lg:pt-24 lg:pb-12 overflow-hidden relative bg-linear-to-b from-blue-200 via-blue-100 via-80% ">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-start mb-8">
            <div className="lg:col-span-5 pt-4">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
                Speak Local.
                <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-indigo-500 to-blue-800">
                  Sell Global.
                </span>
              </h1>

              <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-lg">
                Exceptional products. World-class technology. Outstanding service. Don't let the English language
                barrier become the glass ceiling between your business and international opportunities.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <button
                  type="button"
                  className="bg-primary hover:bg-primary-dark text-white px-8 py-4 rounded-lg font-medium transition-all shadow-lg hover:shadow-primary/25 text-lg"
                >
            ...
            <div className="lg:col-span-6 relative mt-8 lg:mt-0">
              ...
              <div className="relative w-full px-0 py-6 font-sans grid grid-cols-1 sm:grid-cols-3 gap-4">
                <SilentBarrierCard icon={Mail} title="Unanswered Emails" />
                <SilentBarrierCard icon={MessageSquare} title="Lost Conversations" />
                <SilentBarrierCard icon={TrendingDown} title="Missed Deals" />
              </div>
            </div>
          </div>
        </div>
