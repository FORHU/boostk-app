        ...
        <div className="relative h-full w-full">
          ...
          <div className="relative h-full w-full flex flex-col overflow-hidden rounded-xl border-r-[12px] border-r-blue-600 border-b-[12px] border-b-indigo-600 shadow-2xl bg-white transition-transform duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex h-full flex-col p-10 pt-16">
              <h3 className="mb-6 text-3xl font-extrabold text-slate-900 tracking-tight">{title}</h3>

              <div className="mb-auto space-y-4">
                <p className="text-2xl font-medium leading-tight text-slate-400">{question}</p>
              </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-r from-blue-600 via-indigo-500 to-blue-400 p-6 transition-transform duration-300 border-t border-white/20 translate-y-full group-hover:translate-y-0">
              <div className="flex flex-col">
                ...
                <p className="text-xl font-bold leading-tight text-white">{solutionText}</p>
              </div>
            </div>
          </div>
        </div>
