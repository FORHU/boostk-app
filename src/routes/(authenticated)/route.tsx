...
import { ChevronDown, HelpCircle, LayoutDashboard, MessageSquare, MessageSquarePlus, Users, Video } from "lucide-react";
...
function AuthenticatedLayout() {
  ...
  return (
    <div className="flex h-screen w-full font-sans bg-gray-50 text-gray-900">
      {/* Sidebar */}
      <aside className="w-[260px] flex-shrink-0 bg-[#e6f4fe] h-full flex flex-col border-r border-[#d4eaf9]">
        {/* Logo Area */}
