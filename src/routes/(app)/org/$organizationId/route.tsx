...
import { getOrganizationByIdFn } from "@/modules/organization/organization.serverFn";

export const Route = createFileRoute("/(app)/org/$organizationId")({
  beforeLoad: async ({ params }) => {
    const organization = await getOrganizationByIdFn({ data: { orgId: params.organizationId } });
    ...
    <div className="flex flex-col min-h-screen">
      <TopBar>
        <div className="flex items-center gap-2">
          <Link to="/organizations" className="hover:text-gray-900 transition-colors">
            <div className="flex items-center gap-2">
