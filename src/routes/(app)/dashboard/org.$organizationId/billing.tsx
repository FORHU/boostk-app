      ...
      <div className="max-w-7xl mx-auto p-6 md:p-10 space-y-10 bg-background text-foreground">
        <section className="border-b border-border">
          <div className="flex space-x-6 text-sm font-medium">
            <button className="pb-3 text-primary border-b-2 border-primary">Billing</button>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            <div
              className={`w-11 h-6 rounded-full flex items-center p-1 cursor-pointer transition-colors duration-300 ${
            ...
            <span className={isAnnual ? "text-primary font-bold" : "text-muted-foreground"}>
              {" "}
              Annual
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-sm hover:shadow-md  flex flex-col relative">
              ...
              <button className="w-full bg-muted text-muted-foreground font-medium py-2 mb-6">Currnent Plan</button>
            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-sm hover:shadow-md  flex flex-col">
              ...
              <button className="w-full bg-primary text-primary-foreground font-medium py-2 mb-6">Subscribe</button>
