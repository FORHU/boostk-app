...
const mockConversations: Conversation[] = [
  // Active
  {
    ...
    idNumber: "CUS-9284",
    lastMessage:
      "I am writing to report a recurring issue with my account synchronization that has been persistent for the past few days.",
    timestamp: new Date(),
    unreadCount: 2,
    priority: "High",
    status: "active",
              ...
              <div className="divide-y divide-foreground/5">
                {displayedConversations.length === 0 ? (
                  ...
                  displayedConversations.map((conv) => {
                    ...
                    return (
                      // biome-ignore lint/a11y/useSemanticElements: Needs to be a div to contain the nested copy button
                      <div
                        key={conv.id}
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter" || e.key === " ") {
                            e.preventDefault();
                            navigate({ to: `/dashboard/project/${project.id}/chat-support` });
                          }
                        }}
                        role="button"
                        tabIndex={0}
                        className="px-4 py-4 hover:bg-muted/30 transition-colors cursor-pointer flex items-start gap-3 group border-b border-foreground/5 last:border-0 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 flex-wrap mb-0.5">
                            ...
                            <span
                              className={`text-[10px] font-bold px-1.5 py-0.5 rounded-[3px] uppercase tracking-wider border ${
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-[10px] text-[#7f9bd7] font-bold uppercase tracking-widest">
                              #{conv.idNumber}
                            </span>
                            <button
                              type="button"
                          ...
                          <p
                            className={`text-xs truncate mt-1 ${conv.unreadCount > 0 ? "text-slate-900 font-bold" : "text-slate-500"}`}
                          >
                        ...
                        <div className="flex flex-col items-end gap-1 flex-shrink-0">
                          <span
                            className={`text-[10px] font-bold whitespace-nowrap uppercase tracking-widest ${conv.unreadCount > 0 ? "text-[#0037b0]" : "text-slate-400"}`}
                          >
