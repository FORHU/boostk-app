...
function ProjectPage() {
  ...
  return (
    <div className="p-6 relative min-h-screen">
      ...
      <div className="mb-6">
        <p className="text-gray-600 mb-4">Project details for testing RabbitMQ to SSE.</p>
      </div>
      {/* ----- FLOATING CHAT WIDGET UI ----- */}
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        {isChatOpen && (
          <div
            className={`mb-4 rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-5 fade-in duration-200 relative transition-all
